...
# las csc matrices son maneras de representar matrices dispersas, el formato es en vez de guardar todos los elementos que la mayoria
# son 0, se guardan los indices de los elementos no nulos y sus valores. En la columna, primera fila se indica el valor, 
# #y en la segunda fila los indices de las filas donde se encuentran esos valores.
